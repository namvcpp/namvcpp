    ...
    <div className="min-h-screen py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="relative w-full h-64 md:h-80 flex items-center justify-center overflow-hidden rounded-lg mb-4 bg-gradient-to-br from-blue-400 to-purple-600 opacity-80">
            <motion.div className="absolute inset-0 flex items-center justify-center text-white text-9xl font-bold" animate={{ scale: [1, 1.05, 1] }} transition={{ repeat: Infinity, duration: 4 }}>
              N
            </motion.div>
          </div>
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4 mt-4">
              <motion.a href="https://github.com/namvcpp" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400" whileHover={{ y: -3, scale: 1.2 }}>
              ...
              <motion.a href="https://linkedin.com/in/namvcpp" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400" whileHover={{ y: -3, scale: 1.2 }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div>
            ...
            <div className="space-y-6">
              {education.map((item) => (
                <div key={item.institution} className="text-gray-600 dark:text-gray-400">
